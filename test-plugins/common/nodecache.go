...
func (c *NodeCache) List() (node []*v1.Node, nodeName []string) {
	for k, v := range c.nodes {
		node = append(node, v)
		nodeName = append(nodeName, k)
	}
	return
}
...
func NewNodeCache(clientset *kubernetes.Clientset) {
